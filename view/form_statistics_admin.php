										...
										<td>
											...
											<?php
												...
												for ($y=0; $y < $row_cat; $y++) {
													...
													$id_form_table = $array['id'];
													$id_form_option = $array_cat['id'];
													$query_value = "SELECT * FROM form_value where id_form like $form_id AND id_form_table like $id_form_table AND id_form_option like $id_form_option ";
													$result_value = $db->query($query_value);
													$row_value = $result_value->num_rows;
												
												?>
											<label for="age1"> <?php echo $array_cat['name']; ?> - <b><?php echo $row_value; ?></b></label> <br>
											<?php
												}
												?>
										</td>
