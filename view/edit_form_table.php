...
<body class="u-body">
			...
			<div class="container-table100">
				<div class="wrap-table100">
					<?php
						...
						?>
					<div class="table100">
						<button type="submit" class="btn btn-sm btn-outline-secondary col-lg-4 offset-lg-4 col-md-4 col-sm-4 cos-xs-4" style="margin-bottom: 18px" data-toggle="modal" data-target="#exampleModal"><b>Dodaj opcję do pytania</b></button>
						<a  href="../view/edit_form_admin.php?id=<?php echo $form_table; ?>" class="btn btn-sm btn-outline-secondary col-lg-4 offset-lg-4 col-md-4 col-sm-4 cos-xs-4" style="margin-bottom: 18px" ><b>Powrót</b></a>
						<table id="tablePreview" class="table table-striped table-bordered col-md-12 " style="margin-top: 40px">
							...
							<tbody>
								<?php
									$id_form = $_GET['id'];
									$query = "SELECT * FROM form_table_option where id_form_table like $id_form";
								...
								<tr>
									...
									<td><a class='column2 btn btn-sm btn-outline-danger' type='button' href="../action/del_form_option.php?id=<?php echo $array['id'];?>">Usuń</a></td>
								</tr>
								<?php
									}
									?>
	...
	<?php
		echo "<div class=\"modal fade\" id=\"exampleModal\" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'><div class=\"modal-dialog\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-header\">
		          <h4 id='exampleModalLabel' >Nowa opcja</b></h4></div><div class='modal-body'>
		          <form action='../action/add_form_option.php' method='post' name='add' data-toggle='validator' role='form'>";
		?>
	<!--Formularz dodawania -->
	<div class="form-row">
