							...
							<tbody>
								...
								<tr>
									...
									<?php
										if ($array['status']==1){
										?>
									<td><a class='column2 btn btn-sm btn-outline-success' type='button' href="../action/change_progress.php?id=<?php echo $array['id'];?>">Na "w toku"</a></td>
									<?php
										}
										if ($array['status']==2){
										?>
									<td><a class='column2 btn btn-sm btn-outline-success' type='button' href="../action/change_close.php?id=<?php echo $array['id'];?>">Zamknij</a></td>
									<?php
										}
										if ($array['status']==3){ ?>
									<td><a class='column2 btn btn-sm btn-outline-danger' type='button' href="../action/change_open.php?id=<?php echo $array['id'];?>">Otwórz</a></td>
									<?php
										}
										?>
									<td><a class='column2 btn btn-sm btn-outline-primary' type='button' href="diary_manager.php?id=<?php echo $array['id'];?>">Sprawdź dzienniczek</a></td>
								</tr>
								<?php
									}
									?>
