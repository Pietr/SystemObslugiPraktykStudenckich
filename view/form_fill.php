				...
				<div class="wrap-table100">
					<div class="table100">
						<table id="tablePreview" class="table table-striped table-bordered col-md-12 " style="margin-top: 40px">
							...
							<tbody>
								<form action="../action/add_form_fill.php" method="post">
									<?php
									...
									<tr>
										<td>
											...
											<?php
												...
												?>
											<input type="radio"  name="<?php echo $array['id']; ?>" value="<?php echo $array_cat['id']; ?>" required> &nbsp;
